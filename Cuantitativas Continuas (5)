...
# Gráfico de ojiva
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "pink", main = "Ojiva del Peso Corporal",
...
```{r}
# Datos de nivel de contaminación en julio en Iztapalapa
...
hist(contaminacion,
     breaks = k,
     col = "pink",
     main = "Histograma del Nivel de Contaminación (Itztapalapa)",
...
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "blue", main = "Ojiva del Nivel de Contaminación (Itztapalapa)",
...
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "pink", main = "Ojiva de la Temperatura",
...
```
```{r}
# Datos: Tiempos de traslado en horas
tiempo <- c(1.5, 1.3, 1.1, 0.6, 0.9, 1.4, 0.8, 1.7, 1.7, 1.6, 1.7, 1.3, 1.5, 
            0.5, 1.4, 0.6, 1.5, 1.9, 0.7, 1.9, 2.0, 1.6, 0.7, 1.6, 0.7, 0.5, 
            0.6, 1.6, 1.4, 1.9, 1.9, 1.7, 1.7, 1.8, 1.6, 1.4, 1.4, 0.7, 0.8, 
            1.5, 0.8, 1.9, 1.2, 1.9, 1.8, 1.7, 1.5, 1.5, 0.7, 1.8, 1.3, 1.8, 
            0.6, 1.5, 1.4, 1.3, 1.3, 0.8, 1.4, 0.6, 1.1, 1.6, 0.7, 1.5, 2.0, 
            1.7, 0.7, 1.6, 0.8, 1.8, 1.1, 1.6, 1.1, 1.8, 0.8, 1.1, 1.7, 1.4, 
            1.4, 1.2, 1.5, 1.6, 1.6, 1.5, 0.5, 1.4, 1.1, 1.1, 0.9, 0.6, 1.7, 
            1.6, 1.2, 0.6, 1.2, 1.2, 1.8)
...
hist(tiempo,
     breaks = k,
     col = "pink",
     main = "Histograma de Tiempos de Traslado",
     xlab = "Tiempo (horas)",
     ylab = "Frecuencia")
```
```{r}
...
plot(puntos_clase, frecuencia_acumulada, type = "o",
     col = "darkgreen",
     main = "Ojiva de Tiempos de Traslado",
     xlab = "Tiempo (horas)",
