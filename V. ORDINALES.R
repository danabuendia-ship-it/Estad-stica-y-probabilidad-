---
title: "0rdinales NIVEL EDUCATIVO"
...
mediana_num <- as.numeric(NivelEducativo)
mediana <- levels(NivelEducativo)[mediana_num]
mediana
```
...
```
```{r}
NivelSatisfaccion <- c("satisfecho", "muy satisfecho", "muy insatisfecho", "neutral",
                      ...
                      "neutral", "satisfecho", "neutral", "insatisfecho", "mas o menos insatisfecho",
                      "insatisfecho", "mas o menos satisfecho", "satisfecho", "neutral",
                      "insatisfecho", "insatisfecho")
```

```{r}
NivelSatisfaccion <- factor(NivelSatisfaccion,
                           levels = c("muy insatisfecho", "insatisfecho", "mas o menos insatisfecho",
                                      "neutral", "mas o menos satisfecho", "satisfecho", "muy satisfecho"),
                           ordered = TRUE)
...
```{r}
tabla_Satisfaccion <- table(NivelSatisfaccion)
tabla_Satisfaccion
```
...
barplot(tabla_Rangos,
        col = c("violet", "pink", "brown", "orange", "khaki"),
