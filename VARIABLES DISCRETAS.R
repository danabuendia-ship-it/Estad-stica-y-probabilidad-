---
title: "CUANTITATIVAS DISCRETAS 1"
...
points(which.min(Numero_familia), min(Numero_familia), col = "black", pch = 18, cex = 1.8)
points(which.max(Numero_familia), max(Numero_familia), col = "purple", pch = 18, cex = 1.8)
```
...
```{r}
#SUMATORIA DE NUM. DE ESTUDIANTES
...
abline(h = x_media, col = "red", lwd = 1, lty = 2)    
abline(h = Q2, col = "black", lwd = 1, lty = 3)
abline(h = mis_deciles, col = "lightgray", lty = 1.5)
points(which.min(Numero_estudiantes), min(Numero_estudiantes), col = "violet", pch = 17, cex = 1.5)
points(which.max(Numero_estudiantes), max(Numero_estudiantes), col = "green", pch = 17, cex = 1.5)
```
...
abline(h = mis_deciles, col = "lightgray", lty = 1.5)
points(which.min(Goles_partido), min(Goles_partido), col = "red", pch = 17, cex = 1.5)
points(which.max(Goles_partido), max(Goles_partido), col = "purple", pch = 17, cex = 1.5)
```
...
legend(
  ...
  legend = c(mi_min,mi_max),    
  pch = 17,
  col=c("violet","darkblue"),
  pt.cex = 1.5,                
  cex = 0.7,
  bty = "n"                    
)
abline(h = x_media, col = "pink", lwd = 1, lty = 2)    
abline(h = Q2, col = "lightgreen", lwd = 1, lty = 3)
abline(h = mis_deciles, col = "brown", lty = 1.5)
points(which.min(Accidentes_vialidad), min(Accidentes_vialidad), col = "salmon", pch = 17, cex = 1.5)
points(which.max(Accidentes_vialidad), max(Accidentes_vialidad), col = "plum", pch = 17, cex = 1.5)
```
